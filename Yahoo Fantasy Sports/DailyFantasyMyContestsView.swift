//
//  DailyFantasyMyContestsView.swift
...
class DailyFantasyMyContestsView: UIView{
    ...
    func setupSegmentedControl(){
        self.segmentedControl = HMSegmentedControl(sectionTitles: dailyFantasyMyContestsSegmentedTitles)
