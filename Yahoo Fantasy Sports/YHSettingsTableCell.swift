...
protocol YHSettingsTableCellDelegate {
    func didPressSettingsTableCell(indexPath: IndexPath)
}

class YHSettingsTableCell: UITableViewCell, UITableViewDataSource, UITableViewDelegate{
    
    var settingsTableCellDelegate: YHSettingsTableCellDelegate!
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        self.settingsTableCellDelegate.didPressSettingsTableCell(indexPath: indexPath)
    }
}
